...
This directory is the library layer for TorchLean verification workflows: it contains reusable
...
- `TorchLean/`: compilation and spec evaluation glue for reusing the same TorchLean model
