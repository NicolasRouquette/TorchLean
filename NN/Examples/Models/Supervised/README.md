# Supervised Examples (TorchLean)

This folder is for runnable examples where the task is ordinary input and target training:

- `Mlp.lean`: tabular supervised training on the Auto MPG dataset.
...
The `Sequence/` folder is for sequence model behavior itself: recurrent layer checks,
